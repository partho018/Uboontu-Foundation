...
const PreFooter = ({ fortyPlus = '/40+.avif' }) => {
    return (
        <>
                        ...
                        <div className="trust-marquee-wrapper">
                            <div className="trust-marquee-content">
                                <div className="trust-pill-text">
                                    Why Risk It With The <span className="elegant-serif">Wrong Partner?</span> Get 100% Value And Guarantee. Don&apos;t Miss Out — Secure Your <span className="elegant-serif">Brand&apos;s Future</span> Today.&nbsp;&nbsp;
                                </div>
                                <div className="trust-pill-text">
                                    Why Risk It With The <span className="elegant-serif">Wrong Partner?</span> Get 100% Value And Guarantee. Don&apos;t Miss Out — Secure Your <span className="elegant-serif">Brand&apos;s Future</span> Today.&nbsp;&nbsp;
                                </div>
