...
const Consultation = ({ 
    cornerGradient = '/68ba5e44ccb1468ce5b97221_96a931f11af1a2f6b37e251396d130df_6894f274513a65bb1abe220f_Gradient (1)-p-130x130q80.avif', 
    client2 = '/Clint/68db86d8ef94ad655fb9fd01_Client_Austin_916.avif' 
}) => {
        ...
        try {
            const res = await fetch('/api/contacts', {
                ...
                body: JSON.stringify({
                    ...
                    subject: `Project Consultation (Budget: ${selectedBudget || 'Not Specified'})`,
            ...
            if (res.ok && json.ok) {
                ...
                setFormStatus({ submitting: false, success: false, error: json.error || "Submission failed. Please try again." });
            }
        } catch (err) {
                    ...
                    <div className="consultation-info">
                        ...
                        <div className="consultant-card">
                            <div className="consultant-photo-wrapper">
                                <img src={client2} alt="Koushik Mridha" loading="lazy" decoding="async" />
                            </div>
                            <div className="consultant-details">
                                <h4 className="consultant-name">Koushik Mridha</h4>
